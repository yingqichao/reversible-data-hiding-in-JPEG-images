...
public class calctool {
	...
	public int unsignDecoder(int a){//�̶�8λ
		int b=a;
		if(a<0){
			b=255+a+1;
		}
	...
	public int i_unsignDecoder(int a,int num){
		//ע�⣺������Ŀ��������ԭ���������������unsignDecoder���ϸ��溯��,����ĺ�����������������溯��
		//For Example�������֣�00000,����,01111,10000,����,11111�������-31,����,-16,16,����,31
		//λ�����Զ���
		int b=a;
		if(num==0){b=0;}//����AC������Ľ�����������Ҫ
	...
	public int indexOfChar_1(char[] a,int b){
		//ͬ�ϣ��޷��ϲ���https://stackoverflow.com/questions/50493361/java-to-write-a-method-that-can-be-applied-on-any-kind-of-array
		for(int j=0;j<a.length;j++){
			if (a[j]==b) return j;
		}
		return -1;
	...
	public int[] huffmanDecoder(char[] f,int flag,int[][] tree,int row,int col){
		//���ݹ���������Ѱ�����ֶ�Ӧ��Ȩ����λ��
		//row col������ִ�����������ͼ�п���С��У�������debug
		//res0�ǵ�ǰ����λ����res1���ҵ���Ȩֵ
		int[] res = new int[2];boolean found = false;int index;int i;
			...
			if(found==false){res[0] = -1;res[1] = -1;}//Ҫ���ϼ�����ǿ�������û��Զ����ֶ�
